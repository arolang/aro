...
The fine-tuned model that ships with `aro ask` is not large. By the standards of 2026, it is small — a 4-bit quantised 30-billion-parameter coder with enough of its weights shaved off to run comfortably on a laptop with unified memory or a mid-range GPU. This was not a compromise. It was the point.
