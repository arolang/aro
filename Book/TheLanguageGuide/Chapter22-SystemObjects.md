# Chapter 22: System Objects

*"Every program needs to interact with its environment."*

---

## 22.1 What Are System Objects?
...
The file object automatically detects the format based on file extension and serializes/deserializes accordingly. See Chapter 21 for details on format-aware I/O.

---

## 22.3 HTTP Context Objects
...
**Other Magic Objects:**
- `now` — Current UTC timestamp (see Chapter 42: Dates and Times)

---

## 22.7 Plugin System Objects
...
See Chapter 21 for details on creating plugins that provide system objects.
...
*Next: Chapter 23 — Command-Line Parameters*
