# Chapter 18: HTTP Feature Sets

*"Every endpoint tells a story."*

---

## 18.1 HTTP Handler Basics
...
<svg width="540" height="140" viewBox="0 0 540 140" xmlns="http://www.w3.org/2000/svg" font-family="sans-serif">
  <!-- openapi.yaml box -->
  <rect x="20" y="28" width="160" height="72" rx="4" fill="#fef3c7" stroke="#f59e0b" stroke-width="2"/>
  <text x="100" y="48" text-anchor="middle" font-size="10" font-weight="bold" fill="#92400e">openapi.yaml</text>
  <text x="100" y="64" text-anchor="middle" font-size="9" fill="#92400e" font-family="monospace">GET /users</text>
  <text x="100" y="78" text-anchor="middle" font-size="9" fill="#92400e" font-family="monospace">operationId: listUsers</text>
  <text x="100" y="92" text-anchor="middle" font-size="8" fill="#92400e">contract-first definition</text>
  <!-- Arrow 1 -->
  <line x1="182" y1="64" x2="216" y2="64" stroke="#9ca3af" stroke-width="2"/>
  <polygon points="216,59 226,64 216,69" fill="#9ca3af"/>
  <!-- Router box -->
  <rect x="228" y="36" width="100" height="56" rx="4" fill="#1f2937" stroke="#1f2937" stroke-width="2"/>
  <text x="278" y="58" text-anchor="middle" font-size="10" font-weight="bold" fill="#ffffff">ARO</text>
  <text x="278" y="74" text-anchor="middle" font-size="10" fill="#ffffff">router</text>
  <text x="278" y="88" text-anchor="middle" font-size="8" fill="#9ca3af">matches operationId</text>
  <!-- Arrow 2 -->
  <line x1="330" y1="64" x2="364" y2="64" stroke="#9ca3af" stroke-width="2"/>
  <polygon points="364,59 374,64 364,69" fill="#9ca3af"/>
  <!-- Feature set box -->
  <rect x="376" y="28" width="148" height="72" rx="4" fill="#e0e7ff" stroke="#6366f1" stroke-width="2"/>
  <text x="450" y="48" text-anchor="middle" font-size="10" font-weight="bold" fill="#4338ca">Feature Set</text>
  <text x="450" y="64" text-anchor="middle" font-size="9" fill="#4338ca" font-family="monospace">(listUsers: User API)</text>
  <text x="450" y="80" text-anchor="middle" font-size="9" fill="#4338ca">name = operationId</text>
  <text x="450" y="94" text-anchor="middle" font-size="8" fill="#4338ca">exact, case-sensitive match</text>
  <!-- bottom label -->
  <text x="270" y="126" text-anchor="middle" font-size="9" fill="#374151">OpenAPI contract drives routing — operationId is the feature set name</text>
</svg>
</div>
...
*Next: Chapter 19 — Request/Response Patterns*
