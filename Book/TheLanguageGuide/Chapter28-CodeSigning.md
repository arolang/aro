...
<svg xmlns="http://www.w3.org/2000/svg" width="560" height="145" font-family="sans-serif">
  <!-- Label: increasing trust -->
  <text x="280" y="14" text-anchor="middle" font-size="9" fill="#6b7280">increasing trust →</text>
  <line x1="40" y1="18" x2="520" y2="18" stroke="#9ca3af" stroke-width="1" marker-end="url(#arrow)"/>
  <defs>
  ...
  <!-- 1: Unsigned (red) -->
  <rect x="10" y="30" width="120" height="80" rx="4" fill="#fee2e2" stroke="#ef4444" stroke-width="2"/>
  <text x="70" y="55" text-anchor="middle" font-size="11" fill="#991b1b" font-weight="bold">Unsigned</text>
  <text x="70" y="75" text-anchor="middle" font-size="9" fill="#991b1b">Blocked by</text>
  <text x="70" y="88" text-anchor="middle" font-size="9" fill="#991b1b">Gatekeeper</text>

  <!-- Arrow → -->
  <line x1="130" y1="70" x2="148" y2="70" stroke="#9ca3af" stroke-width="1.5"/>
  <polygon points="148,70 140,65 140,75" fill="#9ca3af"/>

  <!-- 2: Ad-hoc (amber) -->
  <rect x="148" y="30" width="120" height="80" rx="4" fill="#fef3c7" stroke="#f59e0b" stroke-width="2"/>
  <text x="208" y="52" text-anchor="middle" font-size="11" fill="#92400e" font-weight="bold">Ad-hoc</text>
  <text x="208" y="67" text-anchor="middle" font-size="9" fill="#92400e">identity: -</text>
  <text x="208" y="84" text-anchor="middle" font-size="9" fill="#92400e">Runs if explicitly</text>
  <text x="208" y="97" text-anchor="middle" font-size="9" fill="#92400e">allowed</text>

  <!-- Arrow → -->
  <line x1="268" y1="70" x2="286" y2="70" stroke="#9ca3af" stroke-width="1.5"/>
  <polygon points="286,70 278,65 278,75" fill="#9ca3af"/>

  <!-- 3: Developer ID (green) -->
  <rect x="286" y="30" width="120" height="80" rx="4" fill="#d1fae5" stroke="#22c55e" stroke-width="2"/>
  <text x="346" y="52" text-anchor="middle" font-size="11" fill="#166534" font-weight="bold">Developer ID</text>
  <text x="346" y="70" text-anchor="middle" font-size="9" fill="#166534">Apple certificate</text>
  <text x="346" y="87" text-anchor="middle" font-size="9" fill="#166534">Runs anywhere</text>

  <!-- Arrow → -->
  <line x1="406" y1="70" x2="424" y2="70" stroke="#9ca3af" stroke-width="1.5"/>
  <polygon points="424,70 416,65 416,75" fill="#9ca3af"/>

  <!-- 4: Developer ID + Notarized (dark) -->
  <rect x="424" y="30" width="126" height="80" rx="4" fill="#1f2937" stroke="#1f2937" stroke-width="2"/>
  <text x="487" y="50" text-anchor="middle" font-size="10" fill="#ffffff" font-weight="bold">Developer ID</text>
  <text x="487" y="64" text-anchor="middle" font-size="10" fill="#ffffff">+ Notarized</text>
  <text x="487" y="82" text-anchor="middle" font-size="9" fill="#d1fae5">Full App Store</text>
  <text x="487" y="95" text-anchor="middle" font-size="9" fill="#d1fae5">trust</text>
</svg>
</div>
...
## 28.5 Combining with Release Builds
...
*Next: Chapter 29 — Multi-file Applications*
