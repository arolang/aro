# Chapter 23: Command-Line Parameters

*"The simplest configuration is the one you type at the prompt."*

---

## 23.1 Why Command-Line Parameters
...
## 23.2 The `parameter` System Object
...
<svg xmlns="http://www.w3.org/2000/svg" width="560" height="130" font-family="sans-serif">
  <!-- Shell command box (left) -->
  <rect x="10" y="40" width="170" height="50" rx="4" fill="#1f2937" stroke="#1f2937" stroke-width="2"/>
  <text x="95" y="61" text-anchor="middle" font-size="10" fill="#ffffff" font-weight="bold">shell command</text>
  <text x="95" y="78" text-anchor="middle" font-size="9" fill="#d1fae5">aro run MyApp --port 8080</text>

  <!-- Arrow + label: argument injection -->
  <line x1="180" y1="65" x2="225" y2="65" stroke="#9ca3af" stroke-width="1.5"/>
  <polygon points="225,65 216,60 216,70" fill="#9ca3af"/>
  <text x="202" y="57" text-anchor="middle" font-size="8" fill="#6b7280">argument</text>
  <text x="202" y="67" text-anchor="middle" font-size="8" fill="#6b7280">injection</text>

  <!-- parameter system object (amber, center) -->
  <rect x="230" y="32" width="145" height="65" rx="4" fill="#fef3c7" stroke="#f59e0b" stroke-width="2"/>
  <text x="302" y="52" text-anchor="middle" font-size="11" fill="#92400e" font-weight="bold">parameter</text>
  <text x="302" y="68" text-anchor="middle" font-size="9" fill="#92400e">system object</text>
  <text x="302" y="83" text-anchor="middle" font-size="9" fill="#92400e">{ port: 8080, … }</text>

  <!-- Arrow right -->
  <line x1="375" y1="65" x2="415" y2="65" stroke="#9ca3af" stroke-width="1.5"/>
  <polygon points="415,65 406,60 406,70" fill="#9ca3af"/>

  <!-- Feature set box (indigo, right) -->
  <rect x="420" y="20" width="130" height="90" rx="4" fill="#e0e7ff" stroke="#6366f1" stroke-width="2"/>
  <text x="485" y="40" text-anchor="middle" font-size="10" fill="#4338ca" font-weight="bold">Feature Set</text>
  <text x="485" y="58" text-anchor="middle" font-size="8" fill="#4338ca">Extract the &lt;port&gt;</text>
  <text x="485" y="72" text-anchor="middle" font-size="8" fill="#4338ca">from the</text>
  <text x="485" y="86" text-anchor="middle" font-size="8" fill="#4338ca">&lt;parameter: port&gt;.</text>
</svg>
</div>

## 23.3 Passing Arguments
...
## 23.8 Parameters vs Environment Variables
...
## 23.9 Complete Example: File Processor
...
*Next: Chapter 24 — Custom Actions*
