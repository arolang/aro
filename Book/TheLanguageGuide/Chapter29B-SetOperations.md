...
Chapter 8 introduced the syntax and type table. This chapter goes deeper: the exact semantics for each type, the `in`/`not in` membership operators, real-world patterns, and how to choose between set operations and other approaches.

---

## 29B.2 The Three Operations
...
## 29B.6 Set Membership in Filter Clauses
...
## 29B.9 Set Operations vs Filter
