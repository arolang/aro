...
<svg width="520" height="220" viewBox="0 0 520 220" xmlns="http://www.w3.org/2000/svg" font-family="sans-serif">
  <!-- Traditional label -->
  <text x="130" y="18" text-anchor="middle" font-size="11" font-weight="bold" fill="#991b1b">Traditional</text>
  <!-- Traditional stack -->
  <rect x="30" y="26" width="200" height="28" rx="4" fill="#fee2e2" stroke="#ef4444" stroke-width="2"/>
  <text x="130" y="45" text-anchor="middle" font-size="10" fill="#991b1b">Code</text>
  <line x1="130" y1="54" x2="130" y2="62" stroke="#ef4444" stroke-width="2"/>
  <polygon points="125,62 130,70 135,62" fill="#ef4444"/>
  <rect x="30" y="70" width="200" height="28" rx="4" fill="#fee2e2" stroke="#ef4444" stroke-width="2"/>
  <text x="130" y="89" text-anchor="middle" font-size="10" fill="#991b1b">try / catch</text>
  <line x1="130" y1="98" x2="130" y2="106" stroke="#ef4444" stroke-width="2"/>
  <polygon points="125,106 130,114 135,106" fill="#ef4444"/>
  <rect x="30" y="114" width="200" height="28" rx="4" fill="#fee2e2" stroke="#ef4444" stroke-width="2"/>
  <text x="130" y="133" text-anchor="middle" font-size="10" fill="#991b1b">error handling logic</text>
  <line x1="130" y1="142" x2="130" y2="150" stroke="#ef4444" stroke-width="2"/>
  <polygon points="125,150 130,158 135,150" fill="#ef4444"/>
  <rect x="30" y="158" width="200" height="28" rx="4" fill="#fee2e2" stroke="#ef4444" stroke-width="2"/>
  <text x="130" y="177" text-anchor="middle" font-size="10" fill="#991b1b">log · format · return error</text>
  <text x="130" y="208" text-anchor="middle" font-size="9" fill="#991b1b">many steps, easy to forget one</text>

  <!-- ARO label -->
  <text x="390" y="18" text-anchor="middle" font-size="11" font-weight="bold" fill="#166534">ARO</text>
  <!-- ARO simple box -->
  <rect x="290" y="26" width="200" height="28" rx="4" fill="#d1fae5" stroke="#22c55e" stroke-width="2"/>
  <text x="390" y="45" text-anchor="middle" font-size="10" fill="#166534">Code</text>
  <line x1="390" y1="54" x2="390" y2="62" stroke="#22c55e" stroke-width="2"/>
  <polygon points="385,62 390,70 395,62" fill="#22c55e"/>
  <rect x="290" y="70" width="200" height="28" rx="4" fill="#d1fae5" stroke="#22c55e" stroke-width="2"/>
  <text x="390" y="89" text-anchor="middle" font-size="10" fill="#166534">runtime error message</text>
  <text x="390" y="208" text-anchor="middle" font-size="9" fill="#166534">automatic, consistent, in business terms</text>
</svg>
</div>
...
## 12.6 Strategies for Complex Error Handling
