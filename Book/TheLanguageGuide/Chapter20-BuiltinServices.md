...
<svg xmlns="http://www.w3.org/2000/svg" width="520" height="220" font-family="sans-serif">
  <!-- ARO Runtime hub (center) -->
  <rect x="195" y="85" width="130" height="50" rx="4" fill="#1f2937" stroke="#1f2937" stroke-width="2"/>
  <text x="260" y="106" text-anchor="middle" font-size="11" fill="#ffffff" font-weight="bold">ARO Runtime</text>
  <text x="260" y="122" text-anchor="middle" font-size="9" fill="#ffffff">EventBus · Services</text>

  <!-- HTTP Server (top-left) -->
  <rect x="20" y="20" width="150" height="52" rx="4" fill="#e0e7ff" stroke="#6366f1" stroke-width="2"/>
  <text x="95" y="40" text-anchor="middle" font-size="11" fill="#4338ca" font-weight="bold">HTTP Server</text>
  <text x="95" y="57" text-anchor="middle" font-size="9" fill="#4338ca">Listen the &lt;http-server&gt;</text>

  <!-- HTTP Client (top-right) -->
  <rect x="350" y="20" width="150" height="52" rx="4" fill="#d1fae5" stroke="#22c55e" stroke-width="2"/>
  <text x="425" y="40" text-anchor="middle" font-size="11" fill="#166534" font-weight="bold">HTTP Client</text>
  <text x="425" y="57" text-anchor="middle" font-size="9" fill="#166534">Fetch the &lt;response&gt;</text>

  <!-- File System (bottom-left) -->
  <rect x="20" y="148" width="150" height="52" rx="4" fill="#fef3c7" stroke="#f59e0b" stroke-width="2"/>
  <text x="95" y="168" text-anchor="middle" font-size="11" fill="#92400e" font-weight="bold">File System</text>
  <text x="95" y="185" text-anchor="middle" font-size="9" fill="#92400e">Read / Write / Stat</text>

  <!-- Sockets (bottom-right) -->
  <rect x="350" y="148" width="150" height="52" rx="4" fill="#fee2e2" stroke="#ef4444" stroke-width="2"/>
  <text x="425" y="168" text-anchor="middle" font-size="11" fill="#991b1b" font-weight="bold">Sockets</text>
  <text x="425" y="185" text-anchor="middle" font-size="9" fill="#991b1b">Connect / Send / Listen</text>

  <!-- Lines: HTTP Server → hub -->
  <line x1="170" y1="46" x2="195" y2="100" stroke="#9ca3af" stroke-width="1.5"/>
  <polygon points="195,100 189,90 198,91" fill="#9ca3af"/>

  <!-- Lines: HTTP Client → hub -->
  <line x1="350" y1="46" x2="325" y2="100" stroke="#9ca3af" stroke-width="1.5"/>
  <polygon points="325,100 326,89 334,91" fill="#9ca3af"/>

  <!-- Lines: File System → hub -->
  <line x1="170" y1="174" x2="195" y2="118" stroke="#9ca3af" stroke-width="1.5"/>
  <polygon points="195,118 189,128 198,127" fill="#9ca3af"/>

  <!-- Lines: Sockets → hub -->
  <line x1="350" y1="174" x2="325" y2="118" stroke="#9ca3af" stroke-width="1.5"/>
  <polygon points="325,118 326,129 334,127" fill="#9ca3af"/>
</svg>
</div>
...
## 20.8 Practical Example: Services in Action
...
*Next: Chapter 21 — Format-Aware I/O*
