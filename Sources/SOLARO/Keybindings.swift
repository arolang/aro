...
enum KeybindingRegistry {
    static let shared: [KeybindingCommand] = [
        ...
        KeybindingCommand(id: "navigation.blame",
                          ...
                          defaultKey: "b",
                          defaultModifiers: [.control, .command]),
        KeybindingCommand(id: "view.zoomIn",
                          displayName: "Increase Text Size",
                          category: .navigation,
                          defaultKey: "+",
                          defaultModifiers: [.command]),
        KeybindingCommand(id: "view.zoomOut",
                          displayName: "Decrease Text Size",
                          category: .navigation,
                          defaultKey: "-",
                          defaultModifiers: [.command]),
        KeybindingCommand(id: "view.zoomReset",
                          displayName: "Actual Text Size",
                          category: .navigation,
                          // NOT ⌘0: that is Toggle Sidebar, and ⌥⌘0
                          // is Toggle Inspector.
                          defaultKey: "0",
                          defaultModifiers: [.command, .shift]),
