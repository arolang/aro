// ============================================================
// ProcessRunner.swift
// AROAsk - helpers for spawning and supervising child processes
// ============================================================
...
enum ProcessRunner {
    ...
    /// Pick a free TCP port in the dynamic range.
    static func randomPort() -> Int {
        Int.random(in: 49152...65535)
    }

    /// Run a process to completion, returning stdout/stderr.
    @discardableResult
