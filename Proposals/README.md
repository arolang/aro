...
numbered Evolution Proposal per topic, 67 of them. The numbering is sparse —
...
| 11 | [HTML/XML Parsing](ARO-0011-html-xml-parsing.md) | `Parse` for HTML and XML documents |
...
| Role | Actions |
|------|---------|
| REQUEST | Extract, Retrieve, Request, Read, List, Stat, Exists, Receive, Probe, Prompt, Select, Stream, Clone, Pull |
| OWN | Compute, Validate, Compare, Transform, Create, Update, Filter, Sort, Map, Reduce, Group, Merge, Join, Split, Delete, Reverse, Call, Execute, Accept, Sleep, Stage, Given, When, Then, Assert |
| RESPONSE | Return, Throw, Log, Send, Write, Append, Store, Render, Notify, Broadcast, Repaint |
| EXPORT | Publish, Emit, Schedule, Commit, Push, Tag |
| SERVER | Start, Stop, Listen, Connect, Close, Copy, Move, Make, WaitForEvents (`Keepalive`) |
