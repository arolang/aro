...
All 74 actions registered by the runtime, with the role, verbs and
...
| 15 | Declare | own | declare | for, with |
| 16 | Delete | own | clear, delete, destroy, remove | for, from |
| 17 | Emit | export | emit | to, with |
| 18 | Execute | own | exec, execute, run, shell | for, on, with |
| 19 | Exists | request | exists | for |
| 20 | Extract | request | extract, get | from, via |
| 21 | Filter | own | filter | from |
| 22 | GitCheckout | own | checkout | from, to, with |
| 23 | GitCommit | export | commit | to, with |
| 24 | Given | own | given | with |
| 25 | Group | own | group | from |
| 26 | Include | own | embed, include, insert | from |
| 27 | Join | own | join | from |
| 28 | List | request | list | from |
| 29 | Listen | server | await, listen | for, on, to |
| 30 | Log | response | debug, log, output, print | for, to, with |
| 31 | Make | server | createdirectory, make, mkdir | at, for, to |
| 32 | Map | own | map | from, to |
| 33 | Merge | own | combine, merge | from, with |
| 34 | Move | server | move, rename | to |
| 35 | Notify | response | alert, notify, signal | for, to, with |
| 36 | ParseDispatch | request | parse | from |
| 37 | ParseHtml | own | parsehtml | from |
...
| 68 | Touch | server | touch | at, for, to |
| 69 | Transform | own | convert, map, transform | from, into, to |
| 70 | Update | own | change, modify, set, update | for, from, into, to, with |
| 71 | Validate | own | check, validate, verify | against, for, with |
| 72 | WaitForEvents | server | block, keepalive, wait | for |
| 73 | When | own | when | from |
| 74 | Write | response | write | into, to |
