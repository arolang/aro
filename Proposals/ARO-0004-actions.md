...
All 70 actions registered by the runtime, with the role, verbs and
...
| 13 | Create | own | build, construct, create | for, from, to, with |
| 14 | Delete | own | clear, delete, destroy, remove | for, from |
| 15 | Emit | export | emit | to, with |
| 16 | Execute | own | exec, execute, run, shell | for, on, with |
| 17 | Exists | request | exists | for |
| 18 | Extract | request | extract, get, parse | from, via |
| 19 | Filter | own | filter | from |
| 20 | GitCheckout | own | checkout | from, to, with |
...
| 28 | Log | response | debug, log, output, print | for, to, with |
| 29 | Make | server | createdirectory, make, mkdir, touch | at, for, to |
| 30 | Map | own | map | from, to |
| 31 | Merge | own | combine, merge | from, with |
| 32 | Move | server | move, rename | to |
| 33 | Notify | response | alert, notify, signal | for, to, with |
| 34 | ParseHtml | own | parsehtml | from |
| 35 | ParseLinkHeader | own | parse | from |
| 36 | Probe | request | probe | from, with |
| 37 | Prompt | request | ask, prompt | from, with |
| 38 | Publish | export | export, expose, publish, share | with |
| 39 | Pull | request | pull | from |
| 40 | Push | export | push | to, with |
| 41 | Read | request | read | from |
| 42 | Receive | request | receive | from, via |
| 43 | Reduce | own | aggregate, reduce | from, with |
| 44 | Render | response | render | to |
| 45 | Repaint | response | patch, repaint | at, to |
| 46 | Request | request | http, request | from, to, via, with |
| 47 | Retrieve | request | fetch, find, load, retrieve | from |
| 48 | Return | response | respond, return | for, to, with |
| 49 | Schedule | export | schedule | with |
| 50 | Select | request | choose, select | from, with |
| 51 | Send | response | dispatch, send | to, via, with |
| 52 | Show | own | show | for |
| 53 | Sleep | own | delay, pause, sleep | for, with |
| 54 | Sort | own | arrange, order, sort | for, with |
| 55 | Split | own | split | from |
| 56 | Stage | own | stage | for, to |
| 57 | Start | server | start | with |
| 58 | Stat | request | stat | for |
| 59 | Stop | server | stop | with |
| 60 | Store | response | persist, save, store | into, to |
| 61 | Stream | request | stream, subscribe | from, with |
| 62 | Tag | export | tag | for, with |
| 63 | Then | own | then | with |
| 64 | Throw | response | fail, raise, throw | for |
| 65 | Transform | own | convert, map, transform | from, into, to |
| 66 | Update | own | change, configure, modify, set, update | for, from, to, with |
| 67 | Validate | own | check, validate, verify | against, for, with |
| 68 | WaitForEvents | server | block, keepalive, wait | for |
| 69 | When | own | when | from |
| 70 | Write | response | write | into, to |
