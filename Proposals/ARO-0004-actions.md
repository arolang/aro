...
| **Execute** | execute, exec, run, shell | for, on, with | Execute system commands |
...
of the 70 registered actions and had drifted on several rows; deriving it removes
that class of problem (GitLab #480).
...
| 30 | Make | server | createdirectory, make, mkdir, touch | at, for, to |
...
| 37 | ParseLinkHeader | own |  | from |
| 38 | Probe | request | probe | from, with |
| 39 | Prompt | request | ask, prompt | from, with |
| 40 | Publish | export | export, expose, publish, share | with |
| 41 | Pull | request | pull | from |
| 42 | Push | export | push | to, with |
| 43 | Read | request | read | from |
| 44 | Receive | request | receive | from, via |
| 45 | Reduce | own | aggregate, reduce | from, with |
| 46 | Render | response | render | to |
| 47 | Repaint | response | patch, repaint | at, to |
| 48 | Request | request | http, request | from, to, via, with |
| 49 | Retrieve | request | fetch, find, load, retrieve | from |
| 50 | Return | response | respond, return | for, to, with |
| 51 | Reverse | own | flip, reverse | for, from, with |
| 52 | Schedule | export | schedule | with |
| 53 | Select | request | choose, select | from, with |
| 54 | Send | response | dispatch, send | to, via, with |
| 55 | Show | own | show | for |
| 56 | Sleep | own | delay, pause, sleep | for, with |
| 57 | Sort | own | arrange, order, sort | for, from, with |
| 58 | Split | own | split | from |
| 59 | Stage | own | stage | for, to |
| 60 | Start | server | start | with |
| 61 | Stat | request | stat | for |
| 62 | Stop | server | stop | with |
| 63 | Store | response | persist, save, store | into, to |
| 64 | Stream | request | stream, subscribe | from, with |
| 65 | Tag | export | tag | for, with |
| 66 | Then | own | then | with |
| 67 | Throw | response | fail, raise, throw | for |
