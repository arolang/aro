...
| **Make** | createdirectory, make, mkdir, touch | at, for, to | Creates a file or directory at the specified path |
...
| 68 | Update | own | change, modify, set, update | for, from, into, to, with |
