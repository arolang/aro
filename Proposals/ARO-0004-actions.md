...
All 71 actions registered by the runtime, with the role, verbs and
...
| 49 | Reverse | own | flip, reverse | for, from, with |
| 50 | Schedule | export | schedule | with |
| 51 | Select | request | choose, select | from, with |
...
| 59 | Stat | request | stat | for |
| 60 | Stop | server | stop | with |
| 61 | Store | response | persist, save, store | into, to |
| 62 | Stream | request | stream, subscribe | from, with |
| 63 | Tag | export | tag | for, with |
...
| 71 | Write | response | write | into, to |
