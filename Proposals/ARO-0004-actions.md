...
| **Attach** | attach | to, with | `Attach the <session> to the <connection>.` — says who a caller is |
...
| **Declare** | declare | for, with | `Declare the <cart-repository> with { scope: "session" }.` |
...
All 75 actions registered by the runtime, with the role, verbs and
...
| 4 | Attach | own | attach | to, with |
| 5 | Broadcast | response | broadcast | to, via |
| 6 | Call | own | call, invoke | from, to, via, with |
| 7 | Clear | own | clear | for |
| 8 | Clone | request | clone | from, to, with |
| 9 | Close | server | close, disconnect, terminate | from, with |
| 10 | Compare | own | compare, match | against, from, to, with |
| 11 | Compute | own | calculate, compute, derive | for, from, with |
| 12 | Configure | own | configure | for, from, into, to, with |
| 13 | Connect | server | connect | to, with |
| 14 | Copy | server | copy | to |
| 15 | Create | own | build, construct, create | for, from, to, with |
| 16 | Declare | own | declare | for, with |
| 17 | Delete | own | clear, delete, destroy, remove | for, from |
| 18 | Emit | export | emit | to, with |
| 19 | Execute | own | exec, execute, run, shell | for, on, with |
| 20 | Exists | request | exists | for |
| 21 | Extract | request | extract, get | from, via |
| 22 | Filter | own | filter | from |
| 23 | GitCheckout | own | checkout | from, to, with |
| 24 | GitCommit | export | commit | to, with |
| 25 | Given | own | given | with |
| 26 | Group | own | group | from |
| 27 | Include | own | embed, include, insert | from |
| 28 | Join | own | join | from |
| 29 | List | request | list | from |
| 30 | Listen | server | await, listen | for, on, to |
| 31 | Log | response | debug, log, output, print | for, to, with |
| 32 | Make | server | createdirectory, make, mkdir | at, for, to |
| 33 | Map | own | map | from, to |
| 34 | Merge | own | combine, merge | from, with |
| 35 | Move | server | move, rename | to |
| 36 | Notify | response | alert, notify, signal | for, to, with |
| 37 | ParseDispatch | request | parse | from |
| 38 | ParseHtml | own | parsehtml | from |
| 39 | Probe | request | probe | from, with |
| 40 | Prompt | request | ask, prompt | from, with |
| 41 | Publish | export | export, expose, publish, share | with |
| 42 | Pull | request | pull | from |
| 43 | Push | export | push | to, with |
| 44 | Read | request | read | from |
| 45 | Receive | request | receive | from, via |
| 46 | Reduce | own | aggregate, reduce | from, with |
| 47 | Render | response | render | to |
| 48 | Repaint | response | patch, repaint | at, to |
| 49 | Request | request | http, request | from, to, via, with |
| 50 | Retrieve | request | fetch, find, load, retrieve | from |
| 51 | Return | response | respond, return | for, to, with |
| 52 | Reverse | own | flip, reverse | for, from, with |
| 53 | Schedule | export | schedule | with |
| 54 | Select | request | choose, select | from, with |
| 55 | Send | response | dispatch, send | to, via, with |
| 56 | Show | own | show | for |
| 57 | Sleep | own | delay, pause, sleep | for, with |
| 58 | Sort | own | arrange, order, sort | for, from, with |
| 59 | Split | own | split | from |
| 60 | Stage | own | stage | for, to |
| 61 | Start | server | start | with |
| 62 | Stat | request | stat | for |
| 63 | Stop | server | stop | with |
| 64 | Store | response | persist, save, store | into, to |
| 65 | Stream | request | stream, subscribe | from, with |
| 66 | Tag | export | tag | for, with |
| 67 | Then | own | then | with |
| 68 | Throw | response | fail, raise, throw | for |
| 69 | Touch | server | touch | at, for, to |
| 70 | Transform | own | convert, map, transform | from, into, to |
| 71 | Update | own | change, modify, set, update | for, from, into, to, with |
| 72 | Validate | own | check, validate, verify | against, for, with |
| 73 | WaitForEvents | server | block, keepalive, wait | for |
| 74 | When | own | when | from |
| 75 | Write | response | write | into, to |
